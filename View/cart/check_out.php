                        ...
                        <div class="checkout-detail-info">
                            ...
                            <table class="order-details">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($selected_cart as $idSP => $item):
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="price-tfoot"><?= number_format($tongtien - $phivc + $giamgia, 0, ',', '.') ?>đ</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="price-tfoot"><?= number_format($tongtien, 0, ',', '.') ?>đ</td>
                                    </tr>
                                </tfoot>
                            </table>
