                ...
                <div class="main-content">
                    <?php
                        ...
                        if (isset($_GET['keyword'])) {
                            ...
                            $query = "SELECT DISTINCT sanpham.*, chitietsanpham.DIEUCHINHGIA 
                                    FROM sanpham 
                                    JOIN chitietsanpham ON sanpham.idSP = chitietsanpham.idSP 
                                    WHERE sanpham.TENSP LIKE ? AND sanpham.TRANGTHAI = 1";
